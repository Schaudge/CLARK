...
The installer builds binaries (CLARK, CLARK-l and CLARK-S, in the folder "bin" in 
CLARKSCV1.3.0). 
...
(binary file in the "bin" directory). 
...
CLARK (or CLARK-l/CLARK-S) built (in the folder "bin") after the installation. If you want
...
```
$ ./bin/CLARK-S -T ./targets_addresses.txt -D ./DBD/ -O ./sample.fq -R ./result -m 0
```
or
```
